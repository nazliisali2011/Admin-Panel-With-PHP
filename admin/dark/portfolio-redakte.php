            ...
            <div class="container-fluid">
               <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Portfolio Elave</h4>
                    </div>  
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Portfolio Elave</h4>
                                ...
                                <input type="hidden" name="id" value="<?= $redakte["id"]?>">
                                 ...
                                 <button name="port_redakte" type="submit" class="btn btn-success mr-2">Redakte Et</button>
