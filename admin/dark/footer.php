<footer class="footer">
    ...
    <?php if($General->PageNameGet()=="portfolio-kat-siyahi" || $General->PageNameGet()=="portfolio-kat"){?>
        <script src="dist/js/portfolio-kat.js"></script>
    <?php } ?>    
    <?php if($General->PageNameGet()=="blog-kat-siyahi" || $General->PageNameGet()=="blog-kat"){?>
        <script src="dist/js/blog-kat.js"></script>
    <?php } ?> 
    ...
    <?php } ?> 
    <?php if($General->PageNameGet()=="blog-siyahi"){?>
        <script src="dist/js/blog.js"></script>
    <?php } ?> 
    <?php if($General->PageNameGet()=="team-siyahi"){?>
        <script src="dist/js/team.js"></script>
    <?php } ?> 
    <?php if($General->PageNameGet()=="admin-add"){?>
        <script src="dist/js/sifre.js"></script>
    <?php } ?> 
    <?php if($General->PageNameGet()=="profile"){?>
